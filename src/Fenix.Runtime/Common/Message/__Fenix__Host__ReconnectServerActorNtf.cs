...
namespace Fenix.Common.Message
{
    ...
    [MessagePackObject]
    public class __Fenix__Host__ReconnectServerActorNtf : IMessageWithCallback
    {
        [Key(0)]
        ...
        public override byte[] Pack()
        {
            return MessagePackSerializer.Serialize<__Fenix__Host__ReconnectServerActorNtf>(this);
        }

        public new static __Fenix__Host__ReconnectServerActorNtf Deserialize(byte[] data)
        {
            return MessagePackSerializer.Deserialize<__Fenix__Host__ReconnectServerActorNtf>(data);
        }

        public override void UnPack(byte[] data)
        {
            var obj = Deserialize(data);
            Copier<__Fenix__Host__ReconnectServerActorNtf>.CopyTo(obj, this);
        }
    }
}
