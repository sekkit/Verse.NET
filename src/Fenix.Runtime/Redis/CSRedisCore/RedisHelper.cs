...
public class RedisHelper : RedisHelper<RedisHelper> { }

public partial class RedisHelper<TMark>
{

    /// <summary>
    /// 永不过期
    /// </summary>
	public readonly int NeverExpired = -1;
    internal ThreadLocal<Random> rnd = new ThreadLocal<Random>();
    /// <summary>
    ...
    /// <returns></returns>
    public int RandomExpired(int minTimeoutSeconds, int maxTimeoutSeconds) => rnd.Value.Next(minTimeoutSeconds, maxTimeoutSeconds);
    ...
    public ConcurrentDictionary<string, RedisClientPool> Nodes => Instance.Nodes;
    ...
    public void Initialization(CSRedisClient csredis)
    {
        _instance = csredis;
    }
    ...
    /// <returns></returns>
    public long SAdd<T>(string key, params T[] members) => Instance.SAdd(key, members);
    /// <summary>
    /// 获取集合的成员数
    /// </summary>
    /// <param name="key">不含prefix前辍</param>
    /// <returns></returns>
    public long SCard(string key) => Instance.SCard(key);
    /// <summary>
    /// 返回给定所有集合的差集
    /// </summary>
    /// <param name="keys">不含prefix前辍</param>
    /// <returns></returns>
    public string[] SDiff(params string[] keys) => Instance.SDiff(keys);
    /// <summary>
    /// 返回给定所有集合的差集
    /// </summary>
    /// <typeparam name="T">byte[] 或其他类型</typeparam>
    /// <param name="keys">不含prefix前辍</param>
    /// <returns></returns>
    public T[] SDiff<T>(params string[] keys) => Instance.SDiff<T>(keys);
    /// <summary>
    ...
    /// <returns></returns>
    public long SDiffStore(string destination, params string[] keys) => Instance.SDiffStore(destination, keys);
    /// <summary>
    /// 返回给定所有集合的交集
    /// </summary>
    /// <param name="keys">不含prefix前辍</param>
    /// <returns></returns>
    public string[] SInter(params string[] keys) => Instance.SInter(keys);
    /// <summary>
    /// 返回给定所有集合的交集
    /// </summary>
    /// <typeparam name="T">byte[] 或其他类型</typeparam>
    /// <param name="keys">不含prefix前辍</param>
    /// <returns></returns>
    public T[] SInter<T>(params string[] keys) => Instance.SInter<T>(keys);
    /// <summary>
    ...
    /// <param name="keys">一个或多个无序集合，不含prefix前辍</param>
    /// <returns></returns>
    public long SInterStore(string destination, params string[] keys) => Instance.SInterStore(destination, keys);
    /// <summary>
    ...
    /// <param name="member">成员</param>
    /// <returns></returns>
    public bool SIsMember(string key, object member) => Instance.SIsMember(key, member);
    /// <summary>
    /// 返回集合中的所有成员
    /// </summary>
    /// <param name="key">不含prefix前辍</param>
    /// <returns></returns>
    public string[] SMembers(string key) => Instance.SMembers(key);
    /// <summary>
    /// 返回集合中的所有成员
    /// </summary>
    /// <typeparam name="T">byte[] 或其他类型</typeparam>
    /// <param name="key">不含prefix前辍</param>
    /// <returns></returns>
    public T[] SMembers<T>(string key) => Instance.SMembers<T>(key);
    /// <summary>
    ...
    /// <param name="member">成员</param>
    /// <returns></returns>
    public bool SMove(string source, string destination, object member) => Instance.SMove(source, destination, member);
    /// <summary>
    /// 移除并返回集合中的一个随机元素
    /// </summary>
    /// <param name="key">不含prefix前辍</param>
    /// <returns></returns>
    public string SPop(string key) => Instance.SPop(key);
    /// <summary>
    /// 移除并返回集合中的一个随机元素
    /// </summary>
    /// <typeparam name="T">byte[] 或其他类型</typeparam>
    /// <param name="key">不含prefix前辍</param>
    /// <returns></returns>
    public T SPop<T>(string key) => Instance.SPop<T>(key);
    /// <summary>
    ...
    /// <returns></returns>
    public string[] SPop(string key, long count) => Instance.SPop(key, count);
    /// <summary>
    /// [redis-server 3.2] 移除并返回集合中的一个或多个随机元素
    /// </summary>
    /// <typeparam name="T">byte[] 或其他类型</typeparam>
    ...
    /// <param name="count">移除并返回的个数</param>
    /// <returns></returns>
    public T[] SPop<T>(string key, long count) => Instance.SPop<T>(key, count);
    /// <summary>
    /// 返回集合中的一个随机元素
    /// </summary>
    /// <param name="key">不含prefix前辍</param>
    /// <returns></returns>
    public string SRandMember(string key) => Instance.SRandMember(key);
    /// <summary>
    /// 返回集合中的一个随机元素
    /// </summary>
    /// <typeparam name="T">byte[] 或其他类型</typeparam>
    /// <param name="key">不含prefix前辍</param>
    /// <returns></returns>
    public T SRandMember<T>(string key) => Instance.SRandMember<T>(key);
    /// <summary>
    /// 返回集合中一个或多个随机数的元素
    /// </summary>
    /// <param name="key">不含prefix前辍</param>
    ...
    /// <returns></returns>
    public string[] SRandMembers(string key, int count = 1) => Instance.SRandMembers(key, count);
    /// <summary>
    /// 返回集合中一个或多个随机数的元素
    /// </summary>
    /// <typeparam name="T">byte[] 或其他类型</typeparam>
    ...
    /// <param name="count">返回个数</param>
    /// <returns></returns>
    public T[] SRandMembers<T>(string key, int count = 1) => Instance.SRandMembers<T>(key, count);
    /// <summary>
    /// 移除集合中一个或多个成员
    /// </summary>
    /// <param name="key">不含prefix前辍</param>
    /// <param name="members">一个或多个成员</param>
    /// <returns></returns>
    public long SRem<T>(string key, params T[] members) => Instance.SRem(key, members);
    /// <summary>
    /// 返回所有给定集合的并集
    /// </summary>
    /// <param name="keys">不含prefix前辍</param>
    /// <returns></returns>
    public string[] SUnion(params string[] keys) => Instance.SUnion(keys);
    /// <summary>
    /// 返回所有给定集合的并集
    /// </summary>
    /// <typeparam name="T">byte[] 或其他类型</typeparam>
    /// <param name="keys">不含prefix前辍</param>
    /// <returns></returns>
    public T[] SUnion<T>(params string[] keys) => Instance.SUnion<T>(keys);
    /// <summary>
    ...
    /// <param name="keys">一个或多个无序集合，不含prefix前辍</param>
    /// <returns></returns>
    public long SUnionStore(string destination, params string[] keys) => Instance.SUnionStore(destination, keys);
    /// <summary>
    /// 迭代集合中的元素
    /// </summary>
    /// <param name="key">不含prefix前辍</param>
    ...
    public bool GeoAdd(string key, decimal longitude, decimal latitude, object member) => Instance.GeoAdd(key, longitude, latitude, member);
    /// <summary>
    /// 将指定的地理空间位置（纬度、经度、成员）添加到指定的key中。这些数据将会存储到sorted set这样的目的是为了方便使用GEORADIUS或者GEORADIUSBYMEMBER命令对数据进行半径查询等操作。
    /// </summary>
    /// <param name="key">不含prefix前辍</param>
    ...
    public long GeoAdd(string key, params (decimal longitude, decimal latitude, object member)[] values) => Instance.GeoAdd(key, values);
    /// <summary>
    ...
    public decimal? GeoDist(string key, object member1, object member2, GeoUnit unit = GeoUnit.m) => Instance.GeoDist(key, member1, member2, unit);
    /// <summary>
    ...
    public (decimal longitude, decimal latitude)?[] GeoPos(string key, object[] members) => Instance.GeoPos(key, members);
