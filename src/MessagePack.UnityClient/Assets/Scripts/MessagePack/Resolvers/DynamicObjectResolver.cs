...
namespace MessagePack.Resolvers
{
    ...
    public sealed class DynamicObjectResolver : IFormatterResolver
    {
        ...
        public static readonly DynamicAssembly DynamicAssembly;
...
namespace MessagePack.Internal
{
    public static class DynamicObjectTypeBuilder
    {
        ...
        public static object BuildFormatterToDynamicMethod(Type type, bool forceStringKey, bool contractless, bool allowPrivate)
        {
            ...
            // public delegate void AnonymousSerializeFunc<T>(byte[][] stringByteKeysField, object[] customFormatters, ref MessagePackWriter writer, T value, MessagePackSerializerOptions options);
            // public delegate T AnonymousDeserializeFunc<T>(object[] customFormatters, ref MessagePackReader reader, MessagePackSerializerOptions options);
...
#pragma warning restore SA1311 // Static readonly fields should begin with upper-case letter
        ...
        public static class MessagePackWriterTypeInfo
        {
        ...
        public static class MessagePackReaderTypeInfo
        {
        ...
        public static class CodeGenHelpersTypeInfo
        {
        ...
        public static class EmitInfo
        {
            ...
            public static class MessagePackFormatterAttr
            {
                public static readonly MethodInfo FormatterType = ExpressionUtility.GetPropertyInfo((MessagePackFormatterAttribute attr) => attr.FormatterType).GetGetMethod();
                public static readonly MethodInfo Arguments = ExpressionUtility.GetPropertyInfo((MessagePackFormatterAttribute attr) => attr.Arguments).GetGetMethod();
            }
        }
    ...
    public class AnonymousSerializableFormatter<T> : IMessagePackFormatter<T>
    {
    ...
    public class MessagePackDynamicObjectResolverException : MessagePackSerializationException
    {
