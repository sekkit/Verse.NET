...
namespace MessagePack
{
    ...
    public class MessagePackSecurity
    {
        ...
        {
            public static readonly CollisionResistantHasher<T> Instance = new CollisionResistantHasher<T>();
        ...
        private class ObjectFallbackEqualityComparer : IEqualityComparer<object>, IEqualityComparer
        {
            ...
            public ObjectFallbackEqualityComparer(MessagePackSecurity security)
            {
        ...
        {
            public static new readonly UInt64EqualityComparer Instance = new UInt64EqualityComparer();
        ...
        {
            public static new readonly Int64EqualityComparer Instance = new Int64EqualityComparer();
        ...
        {
            public static new readonly SingleEqualityComparer Instance = new SingleEqualityComparer();
        ...
        {
            public static new readonly DoubleEqualityComparer Instance = new DoubleEqualityComparer();
        ...
        {
            public static new readonly GuidEqualityComparer Instance = new GuidEqualityComparer();
        ...
        {
            public static new readonly StringEqualityComparer Instance = new StringEqualityComparer();
        ...
        {
            public static new readonly DateTimeEqualityComparer Instance = new DateTimeEqualityComparer();
        ...
        {
            public static new readonly DateTimeOffsetEqualityComparer Instance = new DateTimeOffsetEqualityComparer();
