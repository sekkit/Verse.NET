...
namespace MessagePack.Formatters
{
    ...
    public static class CollectionHelpers<TCollection, TEqualityComparer>
        where TCollection : new()
    {
        ...
        /// </remarks>
        public static TCollection CreateHashCollection(int count, TEqualityComparer equalityComparer) => collectionCreator != null ? collectionCreator.Invoke(count, equalityComparer) : new TCollection();
    }
}
