...
namespace MessagePack.Internal
{
    ...
    public interface IAsymmetricEqualityComparer<TKey1, TKey2>
    {
    ...
    public class StringArraySegmentByteAscymmetricEqualityComparer : IAsymmetricEqualityComparer<byte[], ArraySegment<byte>>
    {
    ...
    public sealed class AsymmetricKeyHashTable<TKey1, TKey2, TValue>
    {
