...
namespace MessagePack
{
    ...
    public static class FormatterResolverExtensions
    {
        ...
        public static IMessagePackFormatter<T> GetFormatterWithVerify<T>(this IFormatterResolver resolver)
        {
            ...
            {
                // The fact that we're using static constructors to initialize this is an public detail.
        ...
        public static object GetFormatterDynamicWithVerify(this IFormatterResolver resolver, Type type)
        {
