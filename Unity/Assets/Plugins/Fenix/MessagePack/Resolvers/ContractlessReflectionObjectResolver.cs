...
namespace MessagePack.Resolvers
{
    ...
    ////    public ReflectionObjectFormatter(ObjectSerializationInfo metaInfo)
    ////    {
    ...
    ////public static class ReflectionObjectFormatterHelper
    ////{
    ////    public static int WriteArraySerialize(ObjectSerializationInfo metaInfo, ObjectSerializationInfo.EmittableMember[] writeMembers, ref byte[] bytes, int offset, object value, IFormatterResolver formatterResolver)
    ////    {
    ...
    ////    public static int WriteMapSerialize(ObjectSerializationInfo metaInfo, ObjectSerializationInfo.EmittableMember[] writeMembers, byte[][] memberNames, ref byte[] bytes, int offset, object value, IFormatterResolver formatterResolver)
    ////    {
    ////        var startOffset = offset;
    ...
    ////    public static object Deserialize(ObjectSerializationInfo metaInfo, ObjectSerializationInfo.EmittableMember[] readMembers, int[] constructorParameterIndexes, AutomataDictionary mapMemberDictionary, byte[] bytes, int offset, IFormatterResolver formatterResolver, out int readSize)
    ////    {
    ////        var startOffset = offset;
