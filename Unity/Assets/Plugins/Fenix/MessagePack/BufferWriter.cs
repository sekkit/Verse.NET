...
namespace MessagePack
{
    ...
    public ref struct BufferWriter
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public BufferWriter(SequencePool sequencePool, byte[] array)
        {
            _buffered = 0;
            _bytesCommitted = 0;
        ...
        /// </summary>
        public IBufferWriter<byte> UnderlyingWriter => _output;

        public SequencePool.Rental SequenceRental => _rental;
        ...
        /// <returns></returns>
        public bool TryGetUncommittedSpan(out ReadOnlySpan<byte> span)
        {
