...
namespace Nerdbank.Streams
{
    ...
    public class Sequence<T> : IBufferWriter<T>, IDisposable
    {
        ...
        private class SequenceSegment : ReadOnlySequenceSegment<T>
        {
            ...
            /// </summary>
            public Memory<T> RemainingMemory => this.AvailableMemory.Slice(this.End);

            /// <summary>
            /// Gets the tail of memory that has not yet been committed.
            /// </summary>
            public Span<T> RemainingSpan => this.AvailableMemory.Span.Slice(this.End);
            ...
            /// </summary>
            public Memory<T> AvailableMemory => this.array ?? this.MemoryOwner?.Memory ?? default;
            ...
            public void Assign(IMemoryOwner<T> memoryOwner)
            {
